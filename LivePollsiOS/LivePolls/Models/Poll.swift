...
//  LivePolls
//
//  Created by Juan Bazan Carrizo on 26/09/2023.
//
...
struct Poll: Codable, Identifiable, Hashable {
    ...
    let lastUpdatedOptionId: String?
    ...
    init(id: String = UUID().uuidString, createdAt: Date? = nil, updatedAt: Date? = nil, name: String, totalCount: Int, options: [Option], lastUpdatedOptionsId: String? = nil) {
        self.id = id
        ...
        self.lastUpdatedOptionId = lastUpdatedOptionsId
    }
}
